...
>
    ...
    >(
        ...
        TCastType
    > {
        return this.#combine(combineTypes.INTERSECT.name, cb);
    }
    ...
    >(
        ...
        TCastType
    > {
        return this.#combine(combineTypes.INTERSECT_ALL.name, cb);
    }
    ...
    >(
        ...
        TCastType
    > {
        return this.#combine(combineTypes.EXCEPT.name, cb);
    }
