...
type typeof_SelectAll_SingleTable_ResultCols = typeof_SelectAll_SingleTable extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_SelectViaTableAlias_SingleTable_ResultCols = typeof_SelectViaTableAlias_SingleTable extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_SelectWhere_WithParams_ResultCols = typeof_SelectWhere_WithParams extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
type typeof_SelectWhere_WithParams_ResultType = ColumnsToResultMap<any, typeof_SelectWhere_WithParams_ResultCols>;
type typeof_SelectWhere_WithParams_Params = typeof selectWhere_WithParams extends QueryBuilder<any, any, any, any, any, any, infer TParams, any, any> ? TParams : never;
...
type typeof_SingleTableSelect_WithTableAlias_ResultCols = typeof_SingleTableSelect_WithTableAlias extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_SelectWithJoins_ResultCols = typeof_SelectWithJoins extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_SelectWithJoins_UsingTableAlias_ResultCols = typeof_SelectWithJoins_UsingTableAlias extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_SelectWithParams_ResultCols = typeof_SelectWithParams extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
type typeof_SelectWithParams_ResultType = ColumnsToResultMap<any, typeof_SelectWithParams_ResultCols>;
type typeof_SelectWithParams_Params = typeof selectWithParams extends QueryBuilder<any, any, any, any, any, any, infer TParams, any, any> ? TParams : never;
...
type typeof_SelectWithParams_ResultType_Expected = { id: number; roundResult: number }[];
...
type typeof_SelectWithJSONBuildObject_ResultCols = typeof_SelectWithJSONBuildObject extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_selectComparison_ResultCols = typeof_selectComparison extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
...
type typeof_selectLogical_ResultCols = typeof_selectLogical extends QueryBuilder<any, any, any, any, any, infer TResult, any, any, any> ? TResult : never;
