...
type typeof_SimpleSQL_WithTypeNull_ValueType = typeof_SimpleSQL_WithTypeNull extends IComparable<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_SimpleSQL_WithTypeNull_FinalValueType = typeof_SimpleSQL_WithTypeNull extends IComparable<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof_SimpleSQL_WithTypeNumberOrNull_ValueType = typeof_SimpleSQL_WithTypeNumberOrNull extends IComparable<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_SimpleSQL_WithTypeNumberOrNull_FinalValueType = typeof_SimpleSQL_WithTypeNumberOrNull extends IComparable<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof_SimpleSQL_WithTypeNull_CastJSON_ValueType = typeof_SimpleSQL_WithTypeNull_CastJSON extends IComparable<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_SimpleSQL_WithTypeNull_CastJSON_FinalValueType = typeof_SimpleSQL_WithTypeNull_CastJSON extends IComparable<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof_SimpleSQL_WithTypeNumber_CastVarchar_ValueType = typeof_SimpleSQL_WithTypeNumber_CastVarchar extends IComparable<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_SimpleSQL_WithTypeNumber_CastVarchar_FinalValueType = typeof_SimpleSQL_WithTypeNumber_CastVarchar extends IComparable<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof_SimpleSQL_WithTypeObj_CastJSONB_ValueType = typeof_SimpleSQL_WithTypeObj_CastJSONB extends IComparable<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_SimpleSQL_WithTypeObj_CastJSONB_FinalValueType = typeof_SimpleSQL_WithTypeObj_CastJSONB extends IComparable<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
