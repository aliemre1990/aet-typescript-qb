...
type typeof_RoundValues_ReturnType = typeof_RoundValues extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
...
type typeof_RoundNonNullParams_ReturnType = typeof_RoundNonNullParams extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
type typeof_RoundNonNullParams_Params = typeof_RoundNonNullParams extends ColumnSQLFunction<any, any, any, any, infer TParams, any, any> ? TParams : never;
type typeof_RoundNonNullParams_ValueParamName = typeof_RoundNonNullParams_Params[0] extends QueryParam<any, infer TName, any, any, any> ? TName : never;
type typeof_RoundNonNullParams_ValueParamType = typeof_RoundNonNullParams_Params[0] extends QueryParam<any, any, infer TValueType, any, any> ? TValueType : never;
type typeof_RoundNonNullParams_DecimalPlaceParamName = typeof_RoundNonNullParams_Params[1] extends QueryParam<any, infer TName, any, any, any> ? TName : never;
type typeof_RoundNonNullParams_DecimalPlaceParamType = typeof_RoundNonNullParams_Params[1] extends QueryParam<any, any, infer TValueType, any, any> ? TValueType : never;
...
type typeof_RoundParamsNotTyped_ReturnType = typeof_RoundParamsNotTyped extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
type typeof_RoundParamsNotTyped_Params = typeof_RoundParamsNotTyped extends ColumnSQLFunction<any, any, any, any, infer TParams, any, any> ? TParams : never;
...
type typeof_RoundParamsValNull_ReturnType = typeof_RoundParamsValNull extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
...
type typeof_RoundParamsValNullableCol_ReturnType = typeof_RoundParamsValNullableCol extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
