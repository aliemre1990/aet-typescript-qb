...
type typeof_NullLiteral_ValueType = typeof_NullLiteral extends IQueryExpression<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_NullLiteral_FinalValueType = typeof_NullLiteral extends IQueryExpression<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof_ObjectLiteral_ValueType = typeof_ObjectLiteral extends IQueryExpression<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_ObjectLiteral_FinalValueType = typeof_ObjectLiteral extends IQueryExpression<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof__NumberLiteral_ValueType = typeof__NumberLiteral_ extends IQueryExpression<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_NumberLiteralF_inalValueType = typeof__NumberLiteral_ extends IQueryExpression<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
...
type typeof_JSONBuildObjectWithLiteral_ValueType = typeof_JSONBuildObjectWithLiteral extends IQueryExpression<any, any, infer TValueType, any, any, any, any> ? TValueType : never;
type typeof_JSONBuildObjectWithLiteral_FinalValueType = typeof_JSONBuildObjectWithLiteral extends IQueryExpression<any, any, any, infer TFinalValueType, any, any, any> ? TFinalValueType : never;
