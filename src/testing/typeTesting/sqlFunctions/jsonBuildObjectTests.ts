...
type typeof_JSONBuildObject_ColumnsSelection_ReturnType = typeof_JSONBuildObject_ColumnsSelection extends JSONBuildObjectFunction<any, any, infer TReturnType, any, any, any> ? TReturnType : never;
...
type typeof_JSONBuildObject_Picked_ReturnType = typeof_JSONBuildObject_Picked extends JSONBuildObjectFunction<any, any, infer TReturnType, any, any, any> ? TReturnType : never;
...
type typeof_JSONBuildObject_PickedWithLiteralValues_ReturnType = typeof_JSONBuildObject_PickedWithLiteralValues extends JSONBuildObjectFunction<any, any, infer TReturnType, any, any, any> ? TReturnType : never;
