...
type typeof_Coalesce_WithParams_NullableNumberParamBefore_ReturnType = typeof_Coalesce_WithParams_NullableNumberParamBefore extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
type typeof_Coalesce_WithParams_NullableNumberParamBefore_Params = typeof_Coalesce_WithParams_NullableNumberParamBefore extends ColumnSQLFunction<any, any, any, any, infer TParams, any, any> ? TParams : never;
type typeof_Coalesce_WithParams_NullableNumberParamBefore_Params_PreviousParamName = typeof_Coalesce_WithParams_NullableNumberParamBefore_Params[0] extends QueryParam<any, infer TName, any, any, any> ? TName : never;
type typeof_Coalesce_WithParams_NullableNumberParamBefore_Params_PreviousParamType = typeof_Coalesce_WithParams_NullableNumberParamBefore_Params[0] extends QueryParam<any, any, infer TValueType, any, any> ? TValueType : never;
type typeof_Coalesce_WithParams_NullableNumberParamBefore_Params_SubsequentParamName = typeof_Coalesce_WithParams_NullableNumberParamBefore_Params[1] extends QueryParam<any, infer TName, any, any, any> ? TName : never;
type typeof_Coalesce_WithParams_NullableNumberParamBefore_Params_SubsequentParamType = typeof_Coalesce_WithParams_NullableNumberParamBefore_Params[1] extends QueryParam<any, any, infer TValueType, any, any> ? TValueType : never;
...
type typeof_Coalesce_WithParams_NullableNumberParamBefore_NonNullParamAfter_ReturnType = typeof_Coalesce_WithParams_NullableNumberParamBefore_NonNullParamAfter extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
...
type typeof_Coalesce_With3Params_LastParamAny_Params = typeof_Coalesce_With3Params_LastParamAny extends ColumnSQLFunction<any, any, any, any, infer TParams, any, any> ? TParams : never;
type typeof_Coalesce_With3Params_LastParamAny_LastParamType = typeof_Coalesce_With3Params_LastParamAny_Params[2] extends QueryParam<any, any, infer TValueType, any, any> ? TValueType : never;
...
type typeof_Coalesce_ParamInferredFromValue_Args = typeof_Coalesce_ParamInferredFromValue extends ColumnSQLFunction<any, any, infer TArgs, any, any, any, any> ? TArgs : never;
type typeof_Coalesce_ParamInferredFromValue_ReturnType = typeof_Coalesce_ParamInferredFromValue extends ColumnSQLFunction<any, any, any, infer TReturnType, any, any, any> ? TReturnType : never;
type typeof_Coalesce_ParamInferredFromValue_Params = typeof_Coalesce_ParamInferredFromValue extends ColumnSQLFunction<any, any, any, any, infer TParams, any, any> ? TParams : never;
type typeof_Coalesce_ParamInferredFromValue_ParamType = typeof_Coalesce_ParamInferredFromValue_Params[0] extends QueryParam<any, any, infer TValueType, any, any> ? TValueType : never;
...
type typeof_Coalesce_WithNestedFunction_Params = typeof_Coalesce_WithNestedFunction extends ColumnSQLFunction<any, any, any, any, infer TParams, any, any> ? TParams : never;
